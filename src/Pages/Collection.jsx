  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        {/* category filter */}
        <div className={`border border-gray-300 pt-5 py-3 mt-6 ${showFilter ? '' : 'hidden' } sm:block`}>
        
          <p className=' mx-2 mb-5 text-sm font-medium'>CATEGORIES</p>
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='mx-3.5 flex gap-2'>
        ...
        {/* Sub-Category filter */}
         ...
         <div className={`border border-gray-300 pt-5 py-3 my-5 ${showFilter ? '' : 'hidden' } sm:block`}>
          <p> </p>
          <p className='mx-2 mb-5 text-sm font-medium'>TYPE</p>
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='mx-3.5 flex gap-2'>
